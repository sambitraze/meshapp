...
class CreateMyTrainingScreen extends StatefulWidget {
  const CreateMyTrainingScreen({Key? key}) : super(key: key);

  @override
  _CreateMyTrainingScreenState createState() => _CreateMyTrainingScreenState();
}

class _CreateMyTrainingScreenState extends State<CreateMyTrainingScreen> {
