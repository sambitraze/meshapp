...
class WinAdaptor extends StatefulWidget {
  ArtistModel? model;
  WinAdaptor({Key? key, this.model}) : super(key: key);

  @override
  _WinAdaptorState createState() => _WinAdaptorState();
}

class _WinAdaptorState extends State<WinAdaptor> {
  @override
